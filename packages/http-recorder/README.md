...
Internal package; depended on as `@openagent-ai/http-recorder` from another
workspace package.

```ts
import { HttpRecorder } from "@openagent-ai/http-recorder"
```
...
```ts
import { HttpRecorder, Redactor } from "@openagent-ai/http-recorder"
