...
const releaseId = process.env.OPENAGENT_RELEASE
if (!releaseId) throw new Error("OPENAGENT_RELEASE is required")

const version = process.env.OPENAGENT_VERSION
if (!version) throw new Error("OPENAGENT_VERSION is required")
...
const macxTarGz = "openagent-desktop-mac-x64.app.tar.gz"
const macaTarGz = "openagent-desktop-mac-arm64.app.tar.gz"
