export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من OpenAgent",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من OpenAgent، هل ترغب في تثبيته وإعادة تشغيله؟",
