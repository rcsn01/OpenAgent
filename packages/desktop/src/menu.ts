    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/rcsn01/OpenAgent"),
            text: t("desktop.menu.help.documentation"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/rcsn01/OpenAgent/issues"),
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/rcsn01/OpenAgent/issues/new"),
