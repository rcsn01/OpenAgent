...
import { lazy } from "@openagent-ai/core/util/lazy"
...
import { NonNegativeInt, PositiveInt } from "@openagent-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@openagent/Pty") {}
