...
import { OpenAgentKeymapProvider, registerOpenAgentKeymap, useBindings, useOpenAgentKeymap } from "./keymap"
...
export function tui(input: {
  ...
  return new Promise<void>(async (resolve) => {
    ...
    const offKeymap = registerOpenAgentKeymap(keymap, renderer, input.config)
    ...
    await render(() => {
      return (
        ...
        >
          <OpenAgentKeymapProvider keymap={keymap}>
