...
import type { OpenAgentClient, PermissionRequest, QuestionRequest, ToolPart } from "@openagent-ai/sdk/v2"
...
type PromptModel = Parameters<OpenAgentClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<OpenAgentClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<OpenAgentClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<OpenAgentClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<OpenAgentClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<OpenAgentClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<OpenAgentClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<OpenAgentClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<OpenAgentClient["question"]["reject"]>[0]
