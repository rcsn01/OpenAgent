...
//
// The saved variant persists across sessions in ~/.local/state/openagent/model.json
...
class Service extends Context.Service<Service, VariantService>()("@openagent/RunVariant") {}
