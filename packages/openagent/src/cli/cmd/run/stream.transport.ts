...
import type { Event, GlobalEvent, OpenAgentClient } from "@openagent-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@openagent/RunStreamTransport") {}
