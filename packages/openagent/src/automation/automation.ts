...
export class Service extends Context.Service<Service, Interface>()("@openagent/Automation") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const running: Interface["running"] = Effect.fn("Automation.running")(function* () {
    ...
    return Service.of({ list, create, update, remove, runs, running, runNow, runDue })
  }),
)
