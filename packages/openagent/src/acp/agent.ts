...
import type { AssistantMessage, Event, OpenAgentClient, SessionMessageResponse, ToolPart } from "@openagent-ai/sdk/v2"
  ...
  private async processMessage(message: SessionMessageResponse) {
    ...
    for (const part of message.parts) {
      if (part.type === "tool") {
        ...
        // OpenAgent stores files internally as { type: "file", url, filename, mime }.
