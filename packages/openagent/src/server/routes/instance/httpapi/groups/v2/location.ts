...
function ref(request: HttpServerRequest.HttpServerRequest): Location.Ref {
  ...
  return {
    directory: query.get("location[directory]") || request.headers["x-openagent-directory"] || process.cwd(),
    workspaceID: query.get("location[workspace]") || request.headers["x-openagent-workspace"],
  }
}
