...
Practical reference for the current tool-migration state in `packages/openagent`.
...
Tool tests should use the existing Effect helpers in `packages/openagent/test/lib/effect.ts`:
