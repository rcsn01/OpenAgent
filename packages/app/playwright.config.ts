  ...
  webServer: [
    {
      ...
      env: {
        ...
        OPENAGENT_DISABLE_PROJECT_CONFIG: "1",
        OPENAGENT_DISABLE_MODELS_FETCH: "1",
        OPENAGENT_CONFIG_CONTENT: JSON.stringify({ model: "opencode/big-pickle" }),
        OPENAGENT_MODELS_PATH: modelsPath,
      },
    },
    {
      command,
      ...
      timeout: 120_000,
      env: {
        VITE_OPENAGENT_SERVER_HOST: serverHost,
        VITE_OPENAGENT_SERVER_PORT: serverPort,
      },
    },
  ],
  use: {
