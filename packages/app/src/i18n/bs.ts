export const dict = {
  ...
  "dialog.provider.openagent.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.openagent.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.openagentGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje OpenAgent",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OpenAgent-u.",
  ...
  "provider.connect.openagentZen.line1":
    "OpenAgent Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.openagentZen.visit.prefix": "Posjeti ",
  "provider.connect.openagentZen.visit.link": "OpenAgent Zen",
  "provider.connect.openagentZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OpenAgent-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OpenAgent-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u openagent.json",
  ...
  "dialog.server.description": "Promijeni na koji se OpenAgent server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija OpenAgent-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku OpenAgent timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (openagent.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: OpenAgent još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "OpenAgent uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni OpenAgent server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u OpenAgent-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako OpenAgent izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li OpenAgent prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu OpenAgent-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se OpenAgent pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju OpenAgent-a.",
