...
export const dict = {
  ...
  "dialog.provider.openagent.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.openagent.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.openagentGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenAgent tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve OpenAgent'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.openagentZen.line1":
    "OpenAgent Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.openagentZen.visit.prefix": "",
  "provider.connect.openagentZen.visit.link": "OpenAgent Zen",
  "provider.connect.openagentZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve OpenAgent'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak OpenAgent'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler openagent.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi OpenAgent sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "OpenAgent'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı OpenAgent ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (openagent.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: OpenAgent henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "OpenAgent ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "OpenAgent Masaüstü",
  ...
  "settings.desktop.wsl.description": "OpenAgent sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "OpenAgent'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "OpenAgent'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "OpenAgent'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "OpenAgent'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "OpenAgent başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "OpenAgent'un en son sürümünü kullanıyorsunuz.",
