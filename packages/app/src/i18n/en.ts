export const dict = {
  ...
  "command.subagents.toggle": "Toggle subagents",
  ...
  "dialog.provider.openagent.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.openagent.tagline": "Reliable optimized models",
  "dialog.provider.openagentGo.tagline": "Low cost subscription for everyone",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenAgent.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.openagentZen.line1":
    "OpenAgent Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.openagentZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.openagentZen.visit.prefix": "Visit ",
  "provider.connect.openagentZen.visit.link": "OpenAgent Zen",
  "provider.connect.openagentZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenAgent.",
  ...
  "dialog.plugins.empty": "Plugins configured in openagent.json",
  ...
  "dialog.server.description": "Switch which OpenAgent server this app connects to.",
  ...
  "toast.update.description": "A new version of OpenAgent ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenAgent team",
  ...
  "error.chain.checkConfig": "Check your config (openagent.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OpenAgent does not support MCP authentication yet.',
  ...
  "session.subagents.summary.graphs": "Graphs",
  "session.subagents.summary.children": "Children",
  "session.subagents.summary.active": "Active",
  "session.subagents.summary.running": "Running",
  "session.subagents.summary.failed": "Failed",
  "session.subagents.loading": "Loading subagents",
  "session.subagents.error": "Failed to load subagent graphs",
  "session.subagents.empty": "No subagents yet.",
  "session.subagents.nodes": "nodes",
  "session.subagents.ungrouped": "Ungrouped",
  ...
  "session.followupDock.autoSend": "Auto-sends when this turn finishes",
  "session.followupDock.autoSendOff": "Auto-send is off",
  "session.followupDock.steer": "Steer",
  "session.followupDock.delete": "Delete queued message",
  "session.followupDock.more": "More queued messages",
  "session.followupDock.actions": "Queued message actions",
  "session.followupDock.sendNow": "Steer",
  "session.followupDock.edit": "Edit",
  "session.followupDock.turnOffAutoSend": "Turn off auto-send",
  "session.followupDock.turnOnAutoSend": "Turn on auto-send",
  ...
  "session.header.search.placeholder.chat": "Search chat files",
  ...
  "sidebar.gettingStarted.line1": "OpenAgent includes free models so you can start immediately.",
  "sidebar.gettingStarted.line2": "Connect any provider to use models, inc. Claude, GPT, Gemini etc.",
  "sidebar.chat.section": "Chats",
  "sidebar.chat.empty": "No chats yet",
  "sidebar.chat.archiveSuccessTitle": "Chat archived",
  "sidebar.chat.archiveSuccessDescription": "Archived 1 chat.",
  "sidebar.project.pinnedSection": "Pinned",
  "sidebar.project.projectsSection": "Projects",
  "sidebar.project.recentSessions": "Recent sessions",
  "sidebar.project.viewAllSessions": "View all sessions",
  "sidebar.project.pin": "Pin project",
  "sidebar.project.unpin": "Unpin project",
  "sidebar.project.createPermanentWorktree": "Create permanent worktree",
  "sidebar.project.archiveChats": "Archive sessions",
  "sidebar.project.remove": "Remove",
  "sidebar.project.archiveConfirmTitle": "Archive sessions",
  "sidebar.project.archiveConfirmDescription.one": 'Archive all sessions in "{{name}}"?',
  "sidebar.project.archiveConfirmDescription.many": 'Archive all {{count}} sessions in "{{name}}"?',
  "sidebar.project.noneToArchiveTitle": "Nothing to archive",
  "sidebar.project.noneToArchiveDescription": "This project does not have any active sessions yet.",
  "sidebar.project.archiveSuccessTitle": "Sessions archived",
  "sidebar.project.archiveSuccessDescription.one": "Archived 1 session.",
  "sidebar.project.archiveSuccessDescription.many": "Archived {{count}} sessions.",
  "sidebar.project.clearNotifications": "Clear notifications",
  "sidebar.project.compact": "Compact projects",
  "sidebar.project.expand": "Expand projects",
  "sidebar.project.viewOptions": "Project view options",
  "sidebar.project.organize": "Organize",
  "sidebar.project.organize.byProject": "By project",
  "sidebar.project.organize.recent": "Recent projects",
  "sidebar.project.organize.chronological": "Chronological list",
  "sidebar.project.sortBy": "Sort by",
  "sidebar.project.sort.created": "Created",
  "sidebar.project.sort.updated": "Updated",
  "sidebar.project.show": "Show",
  "sidebar.project.show.all": "All sessions",
  "sidebar.project.show.relevant": "Relevant",
  "sidebar.project.add": "Add project",
  "sidebar.project.startFromScratch": "Start from scratch",
  "sidebar.project.useExistingFolder": "Use an existing folder",
  ...
  "app.name.desktop": "OpenAgent Desktop",
  ...
  "settings.desktop.wsl.description": "Run the OpenAgent server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for OpenAgent",
  ...
  "settings.general.row.appearance.description": "Customise how OpenAgent looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OpenAgent follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenAgent is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenAgent launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenAgent.",
