export const dict = {
  ...
  "sidebar.project.archiveChats": "Archive chats",
  "sidebar.project.remove": "Remove",
  "sidebar.project.archiveConfirmTitle": "Archive chats",
  "sidebar.project.archiveConfirmDescription.one": 'Archive all chats in "{{name}}"?',
  "sidebar.project.archiveConfirmDescription.many": 'Archive all {{count}} chats in "{{name}}"?',
  "sidebar.project.noneToArchiveTitle": "Nothing to archive",
  "sidebar.project.noneToArchiveDescription": "This project does not have any active chats yet.",
  "sidebar.project.archiveSuccessTitle": "Chats archived",
  "sidebar.project.archiveSuccessDescription.one": "Archived 1 chat.",
  "sidebar.project.archiveSuccessDescription.many": "Archived {{count}} chats.",
  ...
  "sidebar.project.show.all": "All chats",
