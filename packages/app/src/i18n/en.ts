export const dict = {
  ...
  "session.subagents.openSession": "Open child session",
  "session.subagents.inspect.empty": "Select a subagent to inspect details.",
  "session.subagents.inspect.node": "Node",
  "session.subagents.inspect.session": "Session",
  "session.subagents.inspect.dependencies": "Dependencies",
  "session.subagents.inspect.blockedBy": "Blocked by",
  "session.subagents.inspect.title": "Title",
  "session.subagents.inspect.output": "Output",
  "session.subagents.inspect.error": "Error",
