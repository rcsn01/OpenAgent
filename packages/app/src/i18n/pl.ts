export const dict = {
  ...
  "dialog.provider.openagent.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.openagent.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.openagentGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OpenAgent",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OpenAgent.",
  ...
  "provider.connect.openagentZen.line1":
    "OpenAgent Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.openagentZen.visit.prefix": "Odwiedź ",
  "provider.connect.openagentZen.visit.link": "OpenAgent Zen",
  "provider.connect.openagentZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OpenAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OpenAgent.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w openagent.json",
  ...
  "dialog.server.description": "Przełącz serwer OpenAgent, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja OpenAgent ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OpenAgent",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (openagent.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "OpenAgent zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OpenAgent",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd OpenAgent na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OpenAgent ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OpenAgent.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OpenAgent",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OpenAgent.",
