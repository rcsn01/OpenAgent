...
export const loadMcpQuery = (directory: string, sdk: OpenAgentClient) =>
  queryOptions({
    queryKey: [directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadLspQuery = (directory: string, sdk: OpenAgentClient) =>
  queryOptions({
    queryKey: [directory, "lsp"] as const,
    queryFn: () => sdk.lsp.status().then((r) => r.data ?? []),
  })

function makeQueryOptionsApi(globalSDK: () => OpenAgentClient, sdkFor: (dir: PathKey) => OpenAgentClient) {
  return {
...
function createGlobalSync() {
  ...
  const sdkCache = new Map<string, OpenAgentClient>()
