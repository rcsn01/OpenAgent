export type InitStep = { phase: "done" }
...
export type WindowConfig = { updaterEnabled: boolean }
...
export type SpeechCaptureSessionConfig = { gain?: number }
export type SpeechCaptureSessionInfo = { id: string; source: SpeechCaptureSessionSource }
