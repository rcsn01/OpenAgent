...
beforeAll(async () => {
  ...
  mock.module("@openagent/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openagent/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openagent/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openagent/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
