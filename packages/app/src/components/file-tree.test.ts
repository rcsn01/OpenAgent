...
beforeAll(async () => {
  ...
  mock.module("@openagent-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openagent-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openagent-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openagent-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
