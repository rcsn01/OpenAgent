import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@openagent-ai/sdk/v2/client"
...
import { List, type ListRef } from "@openagent-ai/ui/list"
import { ProviderIcon } from "@openagent-ai/ui/provider-icon"
import { Spinner } from "@openagent-ai/ui/spinner"
import { TextField } from "@openagent-ai/ui/text-field"
        ...
        <Switch>
          <Match when={provider().id === "opencode"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.openagentZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.openagentZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.openagentZen.visit.prefix")}
                <Link href="https://openagent.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.openagentZen.visit.link")}
                </Link>
                {language.t("provider.connect.openagentZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
