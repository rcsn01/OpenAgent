...
import { LLM, LLMClient, Provider, ProviderID, Tool, type ProviderModelOptions } from "@openagent-ai/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor } from "@openagent-ai/llm/route"
import { OpenAI } from "@openagent-ai/llm/providers"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-openagent-tutorial": "1" },
    query: { debug: "1" },
  },
})
