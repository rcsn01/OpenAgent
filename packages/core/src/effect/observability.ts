...
import { ensureProcessMetadata } from "../util/openagent-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "openagent.client": Flag.OPENAGENT_CLIENT,
      "openagent.process_role": processMetadata.processRole,
      "openagent.run_id": processMetadata.runID,
