...
// test/preload.ts pins OPENAGENT_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.OPENAGENT_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.OPENAGENT_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.OPENAGENT_MODELS_PATH = undefined
  Flag.OPENAGENT_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.OPENAGENT_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.OPENAGENT_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
