import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@openagent-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
